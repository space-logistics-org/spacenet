...
class FlightTransport(TransportEvent):
    ...
    type: Literal[EventType.FLIGHT_TRANSPORT] = Field(
        EventType.FLIGHT_TRANSPORT, title="Type", description="Event type",
    )
...
class SurfaceTransport(TransportEvent):
    ...
    type: Literal[EventType.SURFACE_TRANSPORT] = Field(
        EventType.SURFACE_TRANSPORT, title="Type", description="Event type",
    )
...
class BurnStageSequence(CamelModel):
    ...
    :param UUID burn: unique identifier of the burn to be achieved
    :param [BurnStageItem] burn_stage_sequence: list of the actions to be performed
    """
...
class SpaceTransport(TransportEvent):
    ...
    :param [BurnStageSequence] burn_stage_sequence: list of burn-stage sequences to perform
    """

    type: Literal[EventType.SPACE_TRANSPORT] = Field(
        EventType.SPACE_TRANSPORT, title="Type", description="Event type",
    )
