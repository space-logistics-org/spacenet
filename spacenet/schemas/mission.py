...
class Mission(BaseModel):
    ...
    demand_models: List[MissionDemand] = Field(..., title="Demand Models List",
                                               description="list of mission demand models")
    origin: SafeInt = Field(..., title="Origin ID", description="ID of origin node")
    destination: SafeInt = Field(..., title="Destination ID",
                                 description="ID of destination node")
    return_origin: SafeInt = Field(..., title="Return Origin ID",
                                   description="ID of return origin node")
    return_destination: SafeInt = Field(..., title="Return Destination ID",
                                        description="ID of return destination node")
