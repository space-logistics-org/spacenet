...
class SurfaceTransport(BaseModel):  # reduces to MoveElements
    ...
    origin_node_id: PositiveInt = Field(..., title="Origin Node ID",
                                        description="The ID of the surface transport's "
                                                    "origin node")

    destination_node_id: PositiveInt = Field(..., title="Destination Node ID",
                                             description="The ID of the surface transport's "
                                                         "destination node")
    ...
    elements_id_list: List[PositiveInt] = Field(..., title="List of Element IDs",
