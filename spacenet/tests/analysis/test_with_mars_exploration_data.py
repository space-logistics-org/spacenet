"""
This module contains tests that the Mars Exploration schema can be simulated without errors.
"""
...
pytestmark = [pytest.mark.analysis, pytest.mark.mars_exploration]


def test_scenario_runs_without_error():
    filename = pkg_resources.resource_filename(
        "spacenet.schemas", "other_scenarios/mars_exploration.json"
    )
