...
class TestGenericResourceAmount(unittest.TestCase):
    ...
    def test_good_data(self):
        self.assertEqual(
            self.test_amount.class_of_supply, self.test_data.get("class_of_supply")
        )
        self.assertEqual(
            self.test_amount.environment, self.test_data.get("environment")
        )
...
class TestGenericResourceAmountRate(unittest.TestCase):
    ...
    def test_good_data(self):
        self.assertEqual(
            self.test_rate.class_of_supply, self.test_data.get("class_of_supply")
        )
