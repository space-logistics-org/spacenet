...
from spacenet.schemas import ClassOfSupply, ContinuousResource, DiscreteResource, Environment, ResourceType
...
class TestDiscreteResource(unittest.TestCase):
    ...
    def test_good_data(self):
        ...
        self.assertEqual(self.test_resource.class_of_supply, self.test_data.get("class_of_supply"))
        self.assertEqual(self.test_resource.environment, self.test_data.get("environment"))
        self.assertEqual(self.test_resource.packing_factor, self.test_data.get("packing_factor"))
        self.assertEqual(self.test_resource.units, self.test_data.get("units"))
        self.assertEqual(self.test_resource.description, self.test_data.get("description"))
        self.assertEqual(self.test_resource.unit_mass, self.test_data.get("unit_mass"))
        self.assertEqual(self.test_resource.unit_volume, self.test_data.get("unit_volume"))
