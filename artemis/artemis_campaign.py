...
sls_srbs_1 = schemas.InstPropulsiveVehicle(
    template_id=sls_srbs.id, name="Artemis 3 | " + sls_srbs.name
)
sls_core_1 = schemas.InstPropulsiveVehicle(
    template_id=sls_core.id, name="Artemis 3 | " + sls_core.name
)
sls_icps_1 = schemas.InstPropulsiveVehicle(
    template_id=sls_icps.id, name="Artemis 3 | " + sls_icps.name
)
sls_sa_1 = schemas.InstElement(
    template_id=sls_sa.id, name="Artemis 3 | " + sls_sa.name
)
orion_sm_1 = schemas.InstPropulsiveVehicle(
    template_id=orion_sm.id, name="Artemis 3 | " + orion_sm.name
)
orion_cm_1 = schemas.InstElementCarrier(
    template_id=orion_cm.id, name="Artemis 3 | " + orion_cm.name
)
sls_las_1 = schemas.InstElementCarrier(
    template_id=sls_las.id, name="Artemis 3 | " + sls_las.name
)
crew_member_1_1 = schemas.InstHumanAgent(
    template_id=crew_member.id, name="Artemis 3 | " + crew_member.name + " A"
)
crew_member_1_2 = schemas.InstHumanAgent(
    template_id=crew_member.id, name="Artemis 3 | " + crew_member.name + " B"
)
crew_member_1_3 = schemas.InstHumanAgent(
    template_id=crew_member.id, name="Artemis 3 | " + crew_member.name + " C"
)
crew_member_1_4 = schemas.InstHumanAgent(
    template_id=crew_member.id, name="Artemis 3 | " + crew_member.name + " D"
)
cargo_1 = schemas.InstElement(template_id=cargo.id, name="Artemis 3 | " + cargo.name)
samples_1 = schemas.InstElement(template_id=samples.id, name="Artemis 3 | " + samples.name)
hls_1 = schemas.InstPropulsiveVehicle(template_id=hls.id, name="Artemis 3 | " + hls.name)

##########################################
# MISSIONS
##########################################
artemis_1 = schemas.Mission(
    name="Artemis 1",
    start_date=datetime(2022, 11, 16, tzinfo=timezone.utc),
    origin=ksc.id,
    destination=pac.id,
    demand_models=[],
    events=[]
)
artemis_2 = schemas.Mission(
    name="Artemis 2",
...
artemis_3 = schemas.Mission(
    ...
    events=[
        schemas.CreateElements(
            name="Artemis 3 | Pre-position Landing System",
        ...
        schemas.CreateElements(
            name="Artemis 3 | Create Launch Stack",
            mission_time=timedelta(0),
            priority=2,
            location=ksc.id,
            container=ksc.id,
        ...
        schemas.CreateElements(
            name="Artemis 3 | Create Crew Members",
            mission_time=timedelta(0),
            priority=3,
            location=ksc.id,
        ...
        schemas.SpaceTransport(
            name="Artemis 3 | Earth Ascent Transport",
            mission_time=timedelta(0),
            priority=4,
            location=ksc.id,
            edge=ksc_leo.id,
        ...
        schemas.SpaceTransport(
            name="Artemis 3 | Trans-Lunar Injection Transport",
        ...
        schemas.MoveElements(
            name="Artemis 3 | Rendezvous, Crew Transfer",
        ...
        schemas.SpaceTransport(
            name="Artemis 3 | Transfer to Low Lunar Orbit",
        ...
        schemas.CrewedExploration(
            name="Artemis 3 | Crewed Exploration",
        ...
        schemas.SpaceTransport(
            name="Artemis 3 | Transfer to Halo Orbit",
        ...
        schemas.MoveElements(
            name="Artemis 3 | Rendezvous, Transfer Crew and Samples",
        ...
        schemas.SpaceTransport(
            name="Artemis 3 | Trans-Earth Injection",
...
scenario = schemas.Scenario(
    ...
    description="A model of NASA's Artemis Campaign.",
    ...
    mission_list=[artemis_1, artemis_2, artemis_3],
...
with open("artemis_campaign.json", "w", encoding="utf-8") as f:
